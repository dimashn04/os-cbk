...
const config = {
  ...
  organizationName: 'dimashn04', // Usually your GitHub org/user name.
  projectName: 'os-cbk', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            type: 'docSidebar',
            sidebarId: 'weeklyAssignmentSidebar',
            position: 'left',
